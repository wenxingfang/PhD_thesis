\chapter*{Extra Phenomenological Analysis£ºModel-independent Constraints on The CKM Matrix Elements $\VTB$, $\VTS$ and $\VTD$}\label{chap:Vtx}

\textit{Single top quark production cross sections at hadron colliders are traditionally used to extract the modulus of the $V_{tb}$ element of the Cabibbo-Kobayashi-Maskawa matrix under the following assumption: $\VTB \gg \VTD, \VTS$.
...
We perform a global fit of top quark related CKM elements to experimental data from the LHC Runs $\RN{1}$ and $\RN{2}$ and Tevatron. Experimental data include inclusive and differential single top cross sections in $t$-channel, inclusive tW production cross section, and top quark branching ratio to b quark and W boson. We present bounds on $|V_{tb}|$, $|V_{ts}|$ and $|V_{td}|$ using current data and project the results for future LHC data sets corresponding to luminosities of 300 and 3000 \invfb.}
...
\begin{figure}[t]
  \begin{center}
    \begin{tabular}{ccc}
      \includegraphics[width=0.3\textwidth]{chapters/Vtx_fig/t_channel_top}&
      \includegraphics[width=0.3\textwidth]{chapters/Vtx_fig/tW_top}&
      \includegraphics[width=0.3\textwidth]{chapters/Vtx_fig/s_channel_top}
    \end{tabular}
...
All cross section measurements, inclusive and differential, are performed in a region with one $b$-tagged jet. This fact is taken into account in this study by comparing the measured cross sections to the corresponding theoretical cross sections times $R$.
...
\begin{figure}[!ht]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_7TeV_top_pt.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_7TeV_atop_pt.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_7TeV_top_rap.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_7TeV_atop_rap.png}\\
    \end{tabular}
...
\begin{figure}[!ht]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_top_pt.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_atop_pt.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_top_Rap.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_atop_Rap.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_top_jet_pt.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_atop_jet_pt.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_top_jet_Rap.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Abs_8TeV_atop_jet_Rap.png}\\
    \end{tabular}
...
%All mentioned variables should be combined using a multi variate approach to maximize the sensitivity of the search~\footnote{Comment by AG: this last sentence is out of place here. It may be moved to the end of the study, suggesting that this is a good thing to do but that we cannot do that in the scope of this study.}.

\begin{figure}[!ht]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_top_pt_fine.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_atop_pt_fine.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_top_Rap_fine.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_atop_Rap_fine.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_top_jet_pt_fine.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_atop_jet_pt_fine.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_top_jet_Rap_fine.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_atop_jet_Rap_fine.png}\\
    \end{tabular}
    \caption{Comparison of the normalized differential cross sections for single top (left) and anti-top (right) production via Wtb (blue line), Wts (red line) and Wtd (Ù„reen line) interactions at particle level. Observables are the same as those shown in Figure \ref{PL-Diff}. Data are taken from Ref. \cite{Aaboud:2017pdi} (ATLAS Collaboration, 8 TeV).
    \label{PL-NormDiff}}
  \end{center}
\end{figure}
...
\begin{figure}[!ht]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_bjet_Rap.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_bjet_Rap.png}\\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_top/H_DR_top_jet.png}&
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/normalized_anti_top/H_DR_atop_jet.png}\\
    \end{tabular}
...
\begin{figure}[ht]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/8TeV/VtbVtd.png}      &
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/all/VtbVtd.png} \\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/8TeV/VtbVts.png}      &
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/all/VtbVts.png} \\
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/8TeV/VtsVtd.png} &
      \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/limit_plot/all/VtsVtd.png} \\
      \end{tabular}
...
\begin{figure}[!ht]
  \begin{center}
        \includegraphics[width=0.75\textwidth]{chapters/Vtx_fig/Diff_8TeV}
      \includegraphics[width=0.75\textwidth]{chapters/Vtx_fig/Diff_8TeV_7TeV_Inclusive}
...
In Figure \ref{proj2D}, the expected  68\% confidence level regions in the ($\VTD$,$\VTS$), ($\VTB$,$\VTS$) and ($\VTD$,$\VTB$) planes obtained using 8 TeV single top differential cross section measurements are compared to expected regions for  300~\invfb and 3000~\invfb of data at 13 TeV. Corresponding individual and marginalized   68\% confidence level regions for the $\VTD$, $\VTS$ and $\VTB$ CKM elements are shown in Table \ref{Projection} and Figure \ref{fig:prospects}.
 ...
 \begin{figure}[ht]
  \begin{center}
            \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Expected_LHC/VtbVtd.png}
            \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Expected_LHC/VtbVts.png}
            \includegraphics[width=0.47\textwidth]{chapters/Vtx_fig/Expected_LHC/VtsVtd.png}
    \caption{Comparison of the expected  68\% confidence level regions in the ($\VTD$,$\VTS$), ($\VTB$,$\VTS$) and ($\VTD$,$\VTB$) planes obtained using 8 TeV single top differential cross section measurements and  68\% confidence level regions expected for 300~\invfb~ and 3000~\invfb~ of data at 13 TeV.
    \label{proj2D}}
  \end{center}
\end{figure}
...
\end{table}
 ...
 \begin{figure}[ht]
  \begin{center}
      \includegraphics[width=0.75\textwidth]{chapters/Vtx_fig/Expected_LHC/Individual.png}
      \includegraphics[width=0.75\textwidth]{chapters/Vtx_fig/Expected_LHC/Marginalized.png}
...
\section*{Summary}
In this study we have set constraints on the CKM elements $\VTD$, $\VTS$ and $\VTB$ using processes involving top quarks without assuming unitarity of the CKM matrix.
