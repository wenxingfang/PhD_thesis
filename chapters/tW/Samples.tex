...
%\caption{Data sets (X) used in this analysis. X = 'DoubleEG' and 'SingleElectron' for the ee channel. X = 'MuonEG','SingleElectron' and 'SingleMuon' for $e\mu$ channel. X = 'DoubleMuon' and 'SingleMuon' for \mumu channel analysis. X = 'MET' for trigger efficiency and scale factor study. The run ranges are adjusted to only include good runs.}
\label{data-samples}
\end{table}

\subsection{MC samples}
The analysis uses centrally produced MC samples from  ``RunIISummer16 MiniAODv2'' campaign as are recommended for Moriond17.
All the MC samples are listed in Table \ref{mc-samples}.
